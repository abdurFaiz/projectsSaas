...
export default function Hero() {
  return (
    <div id='hero' className='relative pt-14 w-full'>
      <TopGradient />
      <BottomGradient />
        ...
        <div className='mx-auto max-w-8xl px-6 lg:px-8'>
          <div className='lg:mb-18 mx-auto max-w-3xl text-center'>
            <h1 className='text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white'>
              Plan Less <span className='italic'>Achieve More</span> — Let AI Handle Your To-Do List
            </h1>
            <p className='mt-6 mx-auto max-w-2xl text-lg leading-8 text-gray-600 dark:text-white'>
              Our intelligent to-do app learns your habits, prioritizes tasks, and keeps you focused — so you can get more done with less effort            </p>
