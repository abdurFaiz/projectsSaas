...
export default function FAQ({ faqs }: { faqs: FAQ[] }) {
  return (
    <div id='faqs' className='mt-32 mx-auto max-w-2xl divide-y divide-gray-900/10 dark:divide-gray-200/10 px-6 pb-8 sm:pb-24 sm:pt-12 lg:max-w-7xl lg:px-8 lg:py-32'>
