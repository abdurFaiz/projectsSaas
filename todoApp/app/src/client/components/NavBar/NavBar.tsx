...
import logo from '../../static/logoSaas.png';
...
const NavLogo = () => <img className='h-8 w-8' src={logo} alt='SimplifAI App' />;
      ...
      <nav className='flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
        <div className='flex items-center lg:flex-1'>
          ...
          >
            <NavLogo />
            {isLandingPage && (
              <span className='ml-2 text-sm font-semibold leading-6 dark:text-white'>SimplifAI</span>
            )}
          </WaspRouterLink>
        </div>
